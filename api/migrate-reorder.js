...
// TEMPORARY one-shot full frequency reorder. Removed after run.
...
const ORDER=["hc-admin", "hc-content", "id-1779739492055-1", "hc-revenue", "from-nico", "id-1772142500118-1", "network", "life-admin", "personal-finance", "id-1772471089249-4", "id-1772471094681-5", "id-1780351450507-1", "friends", "infra", "id-1772480834448-1", "georgetown", "portfolio", "id-1772719720553-1"].concat(['id-1772471887374-9']) // Nico Ideas last
export default async function handler(req,res){
  try{
    ...
    ORDER.forEach((id,i)=>{ b.set(userRef.collection('projects').doc(id),{sortOrder:i},{merge:true}); n++ })
    await b.commit()
    ...
    return res.status(200).json({ok:true,set:n,finalProjects:final})
